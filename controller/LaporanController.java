...
/**
 * Controller khusus untuk menangani pembuatan laporan.
 */
public class LaporanController {
    /**
     * Menampilkan laporan inventaris barang.
     *
     * @param daftarBarang       List semua barang
     * @param daftarPeminjaman   List semua peminjaman (untuk menghitung barang dipinjam)
     */
     ...
     *
     * @param daftarPeminjaman List semua peminjaman
     * @param hanyaAktif       true = hanya peminjaman yang belum dikembalikan,
     *                         false = semua riwayat peminjaman
     */
    ...
    // Overload untuk kemudahan jika ingin langsung menggunakan InventoryController
    // (Opsional) - Memudahkan integrasi tanpa harus mengekspos list secara langsung.
